...
#### First Portfolio ####
invisible(library(PortfolioAnalytics))
...
In this next portfolio, I add Sector Constraints. Allowing the weight of each sector to fluctuate by +/- 10% with a lower bound of zero.
